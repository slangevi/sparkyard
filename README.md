...
| `sparkyard update [--check] [--notes]` | Check for + apply upstream component updates (`--check` = dry-run preview; `--notes` summarizes what they provide via your local gateway). |

...
sparkyard models      # list configured models (--json / --on-disk / --engine)
sparkyard explain M   # dry-run a model's launcher: gmem plan, no load
sparkyard reload      # render + restart the services that read the config
